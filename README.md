...
**Version 1.0.2** · by [Opes](https://opes.dev)
...
| Version | **1.0.2** (see [`VERSION`](VERSION)) |
| License | [MIT](LICENSE) |
...
- `dist\RIP-Demon-1.0.2-windows.zip` — always
- `dist\SHA256SUMS.txt` — checksums for the packaged zip
- `dist\RIP-Demon-Setup-1.0.2.exe` — if [Inno Setup 6](https://jrsoftware.org/isinfo.php) is installed
